...
public class session {
	...
	public void credentials() throws InterruptedException
	{
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("/html/body/div[1]/div/div/div[4]/div[1]/div/div[2]/form/div[1]/div[2]/input")).sendKeys("namitamaurya05@gmail.com");
		driver.findElement(By.id("new-password")).sendKeys("Namita@05");
	...
	{
		Thread.sleep(5000);
		driver.findElement(By.name("first_name")).sendKeys("Namita");
		Thread.sleep(5000);
